                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <div class="p-relative">
                                                <a href="">
                                                    <figure>
                                                        <img src="{{ asset('images/articles/' . $details['photo']) }}" alt="product" width="100" height="100">
                                                    </figure>
                                                </a>
                                        ...
                                        <td class="product-quantity">
                                            <div class="input-group">
                                                ...
                                                <input class="quantite form-control" type="text" name="cart[{{ $product_id }}]"  value="{{ $details['quantity'] ? : 1 }}" data-product-id="{{ $product_id }}">
