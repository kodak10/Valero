                    ...
                    @foreach ($commandes as $commande)
                        <tr>
                            ...
                            <td class="order-total">
                                    <span class="order-quantity">{{ $commande->orderDetails->sum('quantity') }}</span> article(s)
                            </td>
                            <td>
                                <span class="order-price">{{ $commande->orderDetails->sum(fn($detail) => $detail->quantity * $detail->unit_price) }}</span> FCFA
